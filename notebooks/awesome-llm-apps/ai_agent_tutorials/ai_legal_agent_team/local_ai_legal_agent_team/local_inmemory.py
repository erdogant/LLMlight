...
def simple_vector_db():
    """In-memory vector database (dictionary-based)"""
    return {}
    ...
    with tempfile.TemporaryDirectory() as temp_dir:
        ...
        try:
            ...
            knowledge_base = PDFKnowledgeBase(
                path=temp_dir,
                vector_db=vector_db,  # Use the simple in-memory vector_db
...
def main():
    ...
    # Initialize the simple in-memory vector database
    if not st.session_state.vector_db:
        st.session_state.vector_db = simple_vector_db()
